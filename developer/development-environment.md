...
- [Managing the development environment](#managing-the-development-environment)
	...
	- [git_pull](#gitpull)
- [Understanding the Build System Infrastructure](#understanding-the-build-system-infrastructure)
...
* Review the [How to contribute to the OpenSwitch Project Code](./contribute-code.md) guide.
* Follow the [OpenSwitch Coding Style](./contribute-code.md#coding-style) for new code, or follow the existing style in non-OpenSwitch modules.
...
## Understanding the Build System Infrastructure
