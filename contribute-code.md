...
1. Login to [OpenSwitch Reveiw] (https://review.openswitch.net/).
1. At the top right, click the dropdown `Settings` under your name.
1. In the menu on the left, click on Agreements and then click on `New Contributor Agreement`.
