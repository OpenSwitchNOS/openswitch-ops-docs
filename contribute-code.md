...
1. Contact Infra team [infra@lists.openswitch.net](mailto:infra@lists.openswitch.net?Subject=Request%20for%20new%20maintainers%20group) to create the maintainers group <repo-name>-maintainers in gerrit
1. Clone the project with the following command:
```
...
1. Commit the changes with the following command:
   ...
   **Note:** In the commit message, specify the full name for the users in `Git Hub` that you want to add as maintainers of this repository.
   ```
   git commit --signoff
   ```
1. Review the changes with the following command:
