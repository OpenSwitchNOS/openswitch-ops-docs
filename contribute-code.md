...
## Adding new code
You can contribute to the OpenSwitch initiative through one or more of the following ways:
...
- **Infrastructure**--Describes a process in the core of OpenSwitch. These documents are addressed to developers, who want to contribute to the code and only use OpenSwitch.
...
The new repository needs a CMake file to be able to index with the rest of the OpenSwitch project. The easiest way to create a CMake file is to take a similar repository, copy its CMake file and adapt it for the new repository. The CMAke file needs to be added at the root of the new repository.
