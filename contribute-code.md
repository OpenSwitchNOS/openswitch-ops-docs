...
The website is compiled every hour to include any new additions and changes. All changes to existing content on the website can be verified on the [staging area](egats.openswitch.net).
