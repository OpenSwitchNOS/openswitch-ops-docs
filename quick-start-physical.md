...
### Using REST
  ...
  2. The REST documentation is hosted by the OpenSwitch instance. To find the documentation for REST, use the URL `http://<IPAddress>:8091/api/index.html`. For example, `http://192.168.2.19:8091/api/index.html`
  3. Using this portal you can try out different REST GET/PUT/POST calls. It worka directly by posting/getting information from the OVSDB. For more details, refer to usage guides.
